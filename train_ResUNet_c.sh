...
#SBATCH --output=/hkfs/work/workspace/scratch/hgf_pdv3669-H2/logs/train_ResUNet_c.txt
...
python ${group_workspace}/-AI-HERO-2-Health/train.py --fold c --model resdeeplab